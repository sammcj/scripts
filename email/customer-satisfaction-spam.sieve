...
if not anyof(
    ...
    if allof(
        ...
        anyof(
            ...
            # Auto-reply sender addresses
            header :contains :comparator "i;ascii-casemap" "From" ["auto-reply@", "auto.reply@"],
            header :contains :comparator "i;ascii-casemap" "Return-Path" ["auto-reply", "auto.reply"],
